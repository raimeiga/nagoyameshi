     ...
     <div class="row justify-content-center">
         <div class="col-md-5">
             ...
             <form method="POST" action="{{ route('mypage') }}">
                 ...
                 <div class="form-group">
                     <div class="d-flex justify-content-between">
                         <label for="nickname" class="text-md-left samuraimart-edit-user-info-label">ニックネーム</label>
                     </div>
                     <div class="collapse show editUserMail">
                         <input id="nickname" type="text" class="form-control @error('nickname') is-invalid @enderror" name="nickname" value="{{ $user->nickname }}" required autocomplete="nickname" autofocus placeholder="名古屋めしmaster">
                         @error('nickname')
                         <span class="invalid-feedback" role="alert">
                             <strong>アプリ上で使用するニックネームを入力してください</strong>
                         </span>
                         @enderror
                     </div>
                 </div>
